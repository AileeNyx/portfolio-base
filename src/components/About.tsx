...
const About = () => {
  return (
    <section id="about" className="py-20 relative bg-artist-black">
      <div className="absolute inset-0 bg-gradient-radial from-artist-accent/5 via-transparent to-transparent"></div>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-artist-accent/10 via-transparent to-transparent"></div>
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-white/20 backdrop-blur-md rounded-lg z-0"></div>
            <div className="absolute -top-6 -left-6 w-24 h-24 border-2 border-white/40 rounded-lg z-0"></div>
          </motion.div>
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 items-center">
              ...
              {/* <div className="flex gap-4 mt-4 sm:mt-0">
                <a 
                  ...
                  aria-label="Page Facebook de l'artiste"
                >
                ...
                <a 
                  href="https://www.instagram.com/wonderful.gemini/" 
                  className="text-artist-text-light hover:text-artist-accent transition-colors duration-300"
                ...
                <a 
                  href="https://twitter.com/wonderful_gemini" 
                  className="text-artist-text-light hover:text-artist-accent transition-colors duration-300"
                  aria-label="Compte Twitter de l'artiste"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
